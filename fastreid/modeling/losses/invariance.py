...
class ExemplarMemory(Function):
    ...
    @staticmethod
    def forward(self, inputs, targets, em, alpha):
        self.em = em
        self.alpha = alpha
...
class InvNet(nn.Module):
    def __init__(self, num_features, num_classes, beta=0.05, knn=6, alpha=0.01, device='cuda'):
        ...
        # Exemplar memory
        self.em = nn.Parameter(torch.zeros(num_classes, num_features)).cuda(self.device)
